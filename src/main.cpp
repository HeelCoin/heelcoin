...
#if defined(NDEBUG)
# error "HeelCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "HeelCoin Signed Message:\n";
...
#ifdef ENABLE_WALLET
// HeelCoin: attempt to generate suitable proof-of-stake
